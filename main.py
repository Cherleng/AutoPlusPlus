...
class SplashScreen(QWidget):
    def __init__(self):
        ...
        self.timer.start(2)  # every _first_parameter_ ms
...
class MainWindow(QMainWindow):
    ...
    def open_camera(self):
        self.append_log("Open camera")
        # Or: MyApp.append_log(self, "Open camera")
        print("open camera")
        carplate()
    ...
    def open_dir(self):
        ...
        if not selected_dir:
            ...
            global_resource_directory = selected_dir
            print("Current image directory is: " + global_resource_directory)
            self.append_log("Current image directory is: " +
                            global_resource_directory)
    ...
    def open_website(self):
        import webbrowser
        webbrowser.open("https://dynamiclab.xyz/aboutcar")
...
if __name__ == '__main__':
    ...
    global_resource_directory = os.path.abspath(global_resource_directory)
